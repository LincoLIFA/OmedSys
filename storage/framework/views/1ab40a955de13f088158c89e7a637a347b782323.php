                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <h4 class="mt-1 mb-1 text-white"><?php echo e($pacientes->pacnombre); ?></h4>
                                                        <p class="font-13 text-white-50"><?php echo e($pacientes->pacapellidoP); ?> <?php echo e($pacientes->pacapellidoM); ?></p>

                                                        <ul class="mb-0 list-inline text-light">
                                                            <li class="list-inline-item mr-3">
                                                                <h5 class="mb-1"><?php echo e($pacientes->pacidentificacion); ?></h5>
                                                                <p class="mb-0 font-13 text-white-50">RUT</p>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <h5 class="mb-1"><?php echo e($pacientes->pacfechaN); ?></h5>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="text-center mt-sm-0 mt-3 text-sm-right">
                                                    <a type="button"href="<?php echo e(route('UpdateP',$pacientes->id)); ?>" class="btn btn-primary">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-left">
                                            <p class="text-muted"><strong>Nombre: </strong> <span class="ml-2"><?php echo e($pacientes->pacnombre); ?> <?php echo e($pacientes->pacapellidoP); ?> <?php echo e($pacientes->pacapellidoM); ?></span></p>

                                            <p class="text-muted"><strong>Rut :</strong><span class="ml-2"><?php echo e($pacientes->pacidentificacion); ?></span></p>
                                            
                                            <p class="text-muted"><strong>Teléfono :</strong><span class="ml-2"><?php echo e($pacientes->pactelefono); ?></span></p>

                                            <p class="text-muted"><strong>Email :</strong> <span class="ml-2"><?php echo e($pacientes->paccorreo); ?></span></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Personal-Information -->
                                ...
                                <div class="card text-white bg-info overflow-hidden">
                                    <div class="card-body">
                                        <div class="toll-free-box text-center">
                                            <h4><i class="fas fa-mobile"></i>Contacto : <?php echo e($pacientes->pactelefono); ?></h4>
                                        </div>
                                    </div> <!-- end card-body-->
                                </div> <!-- end card-->
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u232615251/domains/geekn.cf/public_html/resources/views/Perfil/paciente.blade.php ENDPATH**/ ?>