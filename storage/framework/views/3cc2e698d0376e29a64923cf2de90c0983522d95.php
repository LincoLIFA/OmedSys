...
if ($mysqli->connect_errno) {
  ...
  $sql2=$mysqli->query("select * from `citas` where citMedico = '{$especialistas->medidentificacion}' ");
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <a href="<?php echo e(url('Citas/aggcitas')); ?>" class="rounded-pill float-right btn btn-primary" >Registrado</a>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="staticEmail" class="col-sm-5 col-form-label">Paciente nuevo</label>
                                                    <div class="col-sm-7">
                                                      <a href="<?php echo e(url('Pacientes/New')); ?>" class="rounded-pill float-right btn btn-primary" >No registrado</a>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <h4 class="mt-1 mb-1 text-white"><?php echo e($especialistas->medidentificacion); ?></h4>
                                                        <p class="font-13 text-white-50"><?php echo e($especialistas->mednombres); ?> <?php echo e($especialistas->medapellidos); ?></p>

                                                        <ul class="mb-0 list-inline text-light">
                                                            <li class="list-inline-item mr-3">
                                                                <h5 class="mb-1"><?php echo e($especialistas->medespecialidad); ?></h5>
                                                                <p class="mb-0 font-13 text-white-50">Especialidad</p>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <h5 class="mb-1"><?php echo e($especialistas->medcorreo); ?></h5>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="text-center mt-sm-0 mt-3 text-sm-right">
                                                    <a type="button"href="<?php echo e(route('UpdateE',$especialistas->id)); ?>" class="btn btn-primary">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-left">
                                            <p class="text-muted"><strong>Nombre: </strong> <span class="ml-2"><?php echo e($especialistas->mednombres); ?> <?php echo e($especialistas->medapellidos); ?></span></p>

                                            <p class="text-muted"><strong>Especialidad :</strong><span class="ml-2"><?php echo e($especialistas->medespecialidad); ?></span></p>
                                            
                                            <p class="text-muted"><strong>Teléfono :</strong><span class="ml-2"><?php echo e($especialistas->medtelefono); ?></span></p>

                                            <p class="text-muted"><strong>Email :</strong> <span class="ml-2"><?php echo e($especialistas->medcorreo); ?></span></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Personal-Information -->
                                ...
                                <div class="card text-white bg-info overflow-hidden">
                                    <div class="card-body">
                                        <div class="toll-free-box text-center">
                                            <h4><i class="fas fa-mobile"></i>Contacto : <?php echo e($especialistas->medtelefono); ?></h4>
                                        </div>
                                    </div> <!-- end card-body-->
                                </div> <!-- end card-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-centered mb-0">
                                                ...
                                                <?php $__currentLoopData = $result3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u232615251/domains/geekn.cf/public_html/resources/views/Perfil/especialista.blade.php ENDPATH**/ ?>