  ...
  <!-- Start Content-->
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                      <form action="<?php echo e(route('AgregarP')); ?>" method="post">
                                          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u232615251/domains/geekn.cf/public_html/resources/views/pacientes/new.blade.php ENDPATH**/ ?>